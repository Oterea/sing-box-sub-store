...
机场名当标题，后面是这次查询用了多久。几条通知靠 Bark 的 `group`
折叠在同一个分组里。
...
```
已推送 2 个机场 + 1 条告警 · 共 0.4s · 2026/9/24 20:33:53
...
> `$content` 是脚本 return 时一次性给出去的。逐条推送让**通知**早到，
> 但浏览器的等待时间不变。
